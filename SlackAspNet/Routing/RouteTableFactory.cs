...
{
	// https://github.com/dotnet/aspnetcore/blob/a57943a443b7699202554ebf0c345859ca5d96db/src/Components/Components/src/Routing/RouteTableFactory.cs
	internal class RouteTableFactory
	{
       private static readonly ConcurrentDictionary<Key, RouteTable> Cache =
        ...
        public static RouteTable Create(IEnumerable<Assembly> assemblies)
        {
            ...
            var componentTypes = key.Assemblies.SelectMany(a => a.ExportedTypes.Where(t => typeof(SlackEndpoint).IsAssignableFrom(t)));
        ...
        internal static RouteTable Create(IEnumerable<Type> componentTypes)
        {
            ...
            foreach (var componentType in componentTypes)
            {
                ...
                var routeAttributes = componentType.GetCustomAttributes<SlackRouteAttribute>(inherit: false);
